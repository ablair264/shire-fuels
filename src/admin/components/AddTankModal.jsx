...
const AddTankModal = ({ isOpen, onClose, onAdd }) => {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Add Oil Tank</h2>
                  <p className="text-sm text-gray-600 mt-1">Add a new oil tank product to the website</p>
                </div>
                <button
                  onClick={handleClose}
                    ...
                    <div>
                      ...
                      {(previewUrl || formData.image_url) ? (
                        <div className="space-y-3">
                          ...
                          <button
                            type="button"
                            onClick={() => document.getElementById('tank-image-upload').click()}
                            disabled={uploading}
